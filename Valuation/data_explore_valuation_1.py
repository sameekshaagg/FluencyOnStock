...
df.drop(columns=['TICKER', 'company_name', 'yearquarter'], inplace=True)
...
empty_mtb_count = merged_df['market_to_book_ratio'].isna().sum()
...
merged_df = merged_df[~merged_df['market_to_book_ratio'].isna()]
